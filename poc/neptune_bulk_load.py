...
def start_bulk_load(
    ...
    iam_role_arn: str,
    region: str,
    user_provided_edge_ids: str = "FALSE",
    parallelism: str = "LOW",
    fail_on_error: str = "FALSE",
    edge_only_load: str = "FALSE",
    queue_request: str = "TRUE",
) -> str:
...
def main():
    ...
    LOCAL_NODE_FILE = os.environ.get("LOCAL_NODE_FILE",
                                     "../data/datasets/roads/nodes.csv")
